...
/**
 * Kundenformulare enthalten Felder für den Vornamen und den Nachnamen eines Kontoinhabers.
 * Für die Erzeugung, das Löschen und das Auffinden anhand des Nachnamens existieren
...
public class Kundenformular {
    ...
    /**
     * Erzeugen der Felder und Schaltflächen.
     * @param bi
     * @return
     */
    ...
    /**
     * Das Setzen des Kunden bewirkt das Befüllen der Formularfelder.
     * @param c
     * @uml.property name="shownCustomer"
     */
    ...
    /**
     * Das Entfernen des Kunden bewirkt das Löschen der Formularfelder.
     *
     */
    void removeCustomer(){
