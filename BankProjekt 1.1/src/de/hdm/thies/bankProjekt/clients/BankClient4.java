 ...
 * <p>
 * <b>Anwendungsfall:</b> Löschen eines Kundenobjekts mit der Kundennr. 11.
 * 
...
public class BankClient4 {
	public static void main(String[] args) {
		try {
			 ...
			 */
			if (c != null ) {
				// Ankündigung, was nun geschieht
				System.out.println("Lösche: " + 
													 c.getLastName() + ", " + 
													 c.getFirstName() );
				
				/*
				 * Die Verwaltung bitten, die Kundin zu löschen. Dies bedeutet implizit,
				 * dass auch deren Konten gelöscht werden. Hierfür sorgt die Verwaltung.
				 */ 
				verwaltung.deleteCustomer(c);

				// Vollzugsmeldung ausgeben
				System.out.println("Kundin gelöscht.");
			}
			else {
