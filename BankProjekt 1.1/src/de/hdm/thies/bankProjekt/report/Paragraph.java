...
/**
 * Reports benötigen die Möglichkeit, Text strukturiert abspeichern
 * zu können. Dieser Text kann später durch <code>ReportWriter</code> in verschiedene
 ...
 * Falle einer rein textuellen Darstellung würde hierzu ein doppeltes "<code>\n</code>" 
 * genügen. Bei dem Zielformat HTML müsste jedoch der gesamte Absatz in 
 * entsprechendes Markup eingefügt werden.<p>
 * 
 * <code>Paragraph</code> ist Serializable, so das Objekte dieser Klasse durch 
 * das Netzwerk übertragbar sind.
 * 
 * @see Report
 * @author Thies
 */
